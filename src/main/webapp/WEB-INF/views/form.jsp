...
<header class="header--form-page">
    <nav class="container container--70">
        ...
        <ul>
            ...
            <li><a href="/" class="btn btn--without-border" id="steps">O co chodzi?</a></li>
            <li><a href="/" class="btn btn--without-border" id="about-us">O nas</a></li>
            <li><a href="/" class="btn btn--without-border" id="help">Fundacje i organizacje</a></li>
            <li><a href="/" class="btn btn--without-border" id="contact">Kontakt</a></li>
        </ul>
    </nav>
