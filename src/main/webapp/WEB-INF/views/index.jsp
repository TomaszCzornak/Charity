...
<header class="header--main-page">
    <nav class="container container--70">
        ...
        <ul>
            ...
            <li><a href="/#steps" class="btn btn--without-border" id="steps">O co chodzi?</a></li>
            <li><a href="/#about-us" class="btn btn--without-border" id="about-us">O nas</a></li>
            <li><a href="/#help" class="btn btn--without-border" id="help">Fundacje i organizacje</a></li>
            <li><a href="/form" class="btn btn--without-border">Przekaż dary</a></li>
            <li><a href="/#contact" class="btn btn--without-border" id="contact">Kontakt</a></li>
        </ul>
    </nav>
